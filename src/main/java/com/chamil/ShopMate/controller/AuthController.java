...
import com.chamil.ShopMate.request.LoginRequest;
import com.chamil.ShopMate.response.AuthResponse;
import com.chamil.ShopMate.service.ShopOwnerUserDetailsService;
...
public class AuthController {
    ...
    @Autowired
    private ShopOwnerUserDetailsService shopOwnerUserDetailsService;
    @Autowired
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody userEntity user) throws Exception {
        ...
        if(isEmailExist != null){
            throw new Exception("Email is already used wih another account");
        }
    ...
    private Authentication authenticate(String username, String password) {
        ...
        UserDetails userDetails = shopOwnerUserDetailsService.loadUserByUsername(username);
